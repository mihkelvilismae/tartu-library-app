    <div class="col-md-10">
        <form action="<?=base_url("Lisa/Zanr"); ?>" class="form-horizontal" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
                <div class="btn-group col-sm-offset-3 col-sm-10">
                    <input type="submit" name="submit" value="Lisa žanr"  class="btn btn-primary btn-sm" />
